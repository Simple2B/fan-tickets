...
var eventImageUploadInput = document.querySelector('#event-image-input');
if (imageUploadInput) {
...
if (eventImageUploadInput) {
    eventImageUploadInput.addEventListener('change', function (e) {
        ...
        if (files && files.length > 0) {
            var file = files[0];
            var instance = 'event';
            var uniqueIdInput = document.querySelector('#event-unique-id');
            handleImageUpload(file, instance, uniqueIdInput.value);
        }
    });
}
function handleImageUpload(file, instance, uniqueId) {
...
function openCloseDropdown(button, container) {
...
var subscribeButton = document.querySelector('#user-profile-subscribe-btn');
var paymentButton = document.querySelector('#user-profile-payment-btn');
var emailButton = document.querySelector('#user-profile-email-btn');
var subscribeContainer = document.querySelector('#user-profile-subscribe-container');
var paymentContainer = document.querySelector('#user-profile-payment-container');
var emailContainer = document.querySelector('#user-profile-email-container');
if (subscribeButton) {
