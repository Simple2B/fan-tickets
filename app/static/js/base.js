...
var headerUserDropdown = document.querySelector('#header-user-dropdown');
var headerUserDropdownButton = document.querySelector('#header-user-dropdown-button');
var headerUserDropdownArrow = document.querySelector('#header-user-dropdown-arrow');
if (headerUserDropdownButton) {
    headerUserDropdownButton.addEventListener('click', function () {
        headerUserDropdownArrow.classList.toggle('rotate-180');
        headerUserDropdown.classList.toggle('header-user-dropdown-active');
        window.addEventListener('mouseup', function (event) {
            if (!headerUserDropdown.contains(event.target)) {
...
var menuButtonClose = document.querySelector('#menu-button-close');
...
var menuMobileDropdowns = document.querySelectorAll('.dropdown');
if (menuMobileDropdowns) {
    menuMobileDropdowns.forEach(function (dropdown) {
...
var verificationInputs = document.querySelectorAll('.auth-register-verification-input');
var verificationButton = document.querySelector('#auth-register-verification-button');
verificationInputs.forEach(function (input, index1) {
    input.addEventListener('keyup', function (event) {
        ...
        if (event.key === 'Backspace') {
            verificationInputs.forEach(function (input, index2) {
        ...
        if (!verificationInputs[5].disabled && verificationInputs[5].value !== '') {
            ...
            verificationButton.classList.remove('auth-register-verification-button-disabled');
            return;
        }
        verificationButton.setAttribute('disabled', 'disabled');
        verificationButton.classList.add('auth-register-verification-button-disabled');
    });
});
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (chatIcon) {
        chatIcon.addEventListener('click', function () {
            setTimeout(function () {
                (0, utils_1.resizeChat)();
            }, 200);
        });
    }
    (0, utils_1.disableDateFlowbite)();
});
window.addEventListener('resize', utils_1.resizeChat);
