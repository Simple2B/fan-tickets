...
exports.toggleDropdown = void 0;
function toggleDropdown(element) {
    element.classList.toggle('dropdown-close');
...
headerUserDropdownButton.addEventListener('click', function () {
    (0, utils_1.toggleDropdown)(headerUserDropdown);
