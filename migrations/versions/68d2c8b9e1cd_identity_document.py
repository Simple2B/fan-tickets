...
Revision ID: 68d2c8b9e1cd
Revises: 9d07ac169469
Create Date: 2023-12-19 15:33:29.955784
...
def upgrade():
    ...
    with op.batch_alter_table("users", schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(
            batch_op.f("fk_users_identity_document_id_pictures"), "pictures", ["identity_document_id"], ["id"]
        )
