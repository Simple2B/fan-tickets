...
Revision ID: 0dfd3c5ea4c5
Revises: 
Create Date: 2024-02-08 16:47:38.185435
...
def upgrade():
    ...
    sa.Column('picture_id', sa.Integer(), nullable=True),
    sa.Column('last_notification_id', sa.Integer(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['last_notification_id'], ['notifications.id'], name=op.f('fk_users_last_notification_id_notifications')),
    ...
    sa.Column('details', sa.Boolean(), server_default=sa.text('false'), nullable=False),
