...
class BaseConfig(BaseSettings):
    ...
    # FT default card
    PAGARME_DEFAULT_FT_CARD_NUMBER: str
    PAGARME_DEFAULT_FT_CARD_HOLDER_NAME: str
    PAGARME_DEFAULT_FT_CARD_HOLDER_DOCUMENT: str
    PAGARME_DEFAULT_FT_CARD_EXP_MONTH: int
    PAGARME_DEFAULT_FT_CARD_EXP_YEAR: int
    PAGARME_DEFAULT_FT_CARD_CVV: str
    PAGARME_DEFAULT_FT_CARD_BRAND: str
    PAGARME_DEFAULT_FT_CARD_LABEL: str
    PAGARME_DEFAULT_FT_CARD_STATE: str
    PAGARME_DEFAULT_FT_CARD_ZIP_CODE: str
    PAGARME_DEFAULT_FT_CARD_CITY: str
    PAGARME_DEFAULT_FT_CARD_BILLING_LINE_1: str
    PAGARME_DEFAULT_FT_CARD_BILLING_LINE_2: str
